...
public final class DroneEngineLoopSoundInstance extends AbstractTickableSoundInstance {
    ...
    public void update(
        ...
        final float baseVolume = 0.8F + 1.2F * mix;
        final float basePitch = 0.85F + 0.3F * mix + speedFactor * 0.15F;
        this.targetVolume = Mth.clamp(baseVolume * speedVolumeMult, 0.0F, 4.0F);
    ...
    public void tick() {
        ...
        this.pitch = Mth.lerp(0.25F, this.pitch, this.targetPitch * currentDopplerPitch);
        applyFilter();
